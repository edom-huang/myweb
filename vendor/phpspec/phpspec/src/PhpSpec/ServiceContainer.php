...
/**
 * The Services Container is a lightweight container based on Pimple to handle
...
class ServiceContainer
{
    ...
    public function set($id, $value)
    {
        if (!is_object($value) && !is_callable($value)) {
            throw new InvalidArgumentException(sprintf(
                'Services should be callable or object, but %s given.',
                gettype($value)
            ));
        }
    ...
    public function setShared($id, $callable)
    {
        if (!is_callable($callable)) {
            throw new InvalidArgumentException(sprintf(
                'Services should be callable, "%s" given.',
                gettype($callable)
            ));
        }
    ...
    public function get($id)
    {
        if (!array_key_exists($id, $this->services)) {
            throw new InvalidArgumentException(sprintf('Services "%s" is not defined.', $id));
        }
